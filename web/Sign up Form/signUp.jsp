...
<body>
  <form action="" class="form" id="form-signUp" method="POST">
    <div class="logo">
    ...
    <div class="container row">
      <div class="col">
        ...
        <div class="form-group">
          ...
          <input type="text" name="password" id="password" placeholder="Input your word" class="form-input"
            rules="isRequired|min:6" />
          <span class="error-control"></span>
        </div>
        <div class="form-group">
          <label for="confirm-password" class="lb-control">Confirm Password</label>
          <input type="text" name="confirm-password" id="confirm-password" placeholder="Confirm your password"
